...
ARG NEXT_PUBLIC_KEPLR_CHAIN_NAME
ARG NEXT_PUBLIC_KEPLR_RPC_ADDRESS
ARG NEXT_PUBLIC_KEPLR_LCD_ADDRESS
...
ENV NEXT_PUBLIC_KEPLR_CHAIN_NAME ${NEXT_PUBLIC_KEPLR_CHAIN_NAME}
ENV NEXT_PUBLIC_KEPLR_RPC_ADDRESS ${NEXT_PUBLIC_KEPLR_RPC_ADDRESS}
ENV NEXT_PUBLIC_KEPLR_LCD_ADDRESS ${NEXT_PUBLIC_KEPLR_LCD_ADDRESS}
